...
const app_title = "NEC Electrical Exam Prep 2025";
...
const onboardD1 = "Prepare smarter with expert-crafted NEC questions and personalized study tools. Pass with confidence and ease!";

const onboardT2 = "Prepare with Confidence!";
const onboardD2 = "Access high-quality NEC practice questions with in-depth explanations. Track your progress and power through your exam!";

const onboardT3 = "Your NEC Study Companion";
const onboardD3 = "Boost your exam readiness with targeted practice questions. Get real-time feedback and insights to stay on track!";

const onboardT4 = "Track Your Progress";
const onboardD4 = "Monitor your performance, pinpoint weak areas, and celebrate your achievements as you advance through each stage of the exam!";
