...
import '../../../reuseable_widgets/progress_loading_indicator.dart';
import '../../../reuseable_widgets/reusable_button.dart';
import '../bloc/subscription_bloc.dart';
import '../bloc/subscription_event.dart';
import '../bloc/subscription_state.dart';
import '../model/purchase_receipt_android.dart';
import '../model/purchase_receipt_ios.dart';
import '../widgets/common_utils.dart';
import '../widgets/subscription_plan_view.dart';
...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  ...
  Future<AccessCredentials> obtainCredentials() async {
    var accountCredentials = ServiceAccountCredentials.fromJson({
      StringConstant.privateKeyId: "<private key id from secure space>",
      StringConstant.privateKey: "<private key from secure space>",
      StringConstant.clientEmail: "<client email from secure space>",
      StringConstant.clientId: "<client id from secure space>",
      StringConstant.type: "<type from secure space>",
    });
    var scopes = [verifyingScope];
              ...
              return Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _unlockSubscriptionView(),
                    _chooseSubscriptionDetailsView(),
